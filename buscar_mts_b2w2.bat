...
setlocal
cd /d "%~dp0"
title RoleRun - Buscar la tabla de MT (Negro 2)

echo ============================================================
echo   BUSCAR LA TABLA DE MT - Pokemon Negro 2 / Blanco 2
echo ============================================================
echo.
...
where py >nul 2>nul
if not errorlevel 1 (
    py -3 tools_b2w2_tm_table_capture.py
) else (
    python tools_b2w2_tm_table_capture.py
)
