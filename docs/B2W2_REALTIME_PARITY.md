...
| PC intercambio | Cruzar dos casillas del PC **ocupadas las dos** | `swap_pc_slots` (05-09-2026, alpha.27): **IMPLEMENTADO · TEST**, sin ningún vacío de por medio y con las dos identidades como ancla. Misma transacción que `move_pc_slot`, cruzada | **PENDIENTE DE VALIDACIÓN FÍSICA**: intercambiar dos ocupadas, en la misma caja y entre cajas distintas |
...
| Mochila | Bolsillos, MT/cantidades y utilidades | **ESTRUCTURA DEMOSTRADA** (27-08-2026). Mochila en `0x0221D9A4`; bolsillos Items +0, Objetos clave +1240, MT/MO +1572, Medicinas +2008, Bayas +2200; cada hueco son dos u16 (identificador, cantidad). Las tres fronteras medidas en la RAM del usuario coinciden **byte a byte** con `SAV5B2W2.Inventory.Pouches` de PKHeX. **Reader IMPLEMENTADO · TEST · VALIDADO FÍSICAMENTE** (27-08-2026, alpha.37). Publicado por el contrato común `read_tm_inventory` desde alpha.38. **Writer IMPLEMENTADO · TEST · VALIDADO FÍSICAMENTE** (27-08-2026, alpha.39): utilidades de cabecera (Caramelo Raro #50, Repelente Máximo #77) con contrato transaccional completo **MT CONECTADAS · TEST** (alpha.42): pantalla MT, selector y writer de enseñanza. MT reutilizable, no se gasta **VALIDADO FÍSICAMENTE** (27-08-2026) | Cerrado |
...
| Progreso | Medallas/gimnasios sin retroceso ni duplicado | **IMPLEMENTADO · TEST** (alpha.50): `0x022266A8`, un bit por medalla, cuatro bytes detrás del dinero ya demostrado. Deducido de PKHeX y confirmado contra el guardado real (4524 en `0x21100`) **DIRECCIÓN CONFIRMADA** contra el juego (27-08-2026): con 1 medalla, `0x022266A8` = 0x01 **VALIDADO FÍSICAMENTE** (27-08-2026): el contador marcó 1 | Cerrado |
