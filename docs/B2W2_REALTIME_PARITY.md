...
| Muertes | Baseline, >0→0, varios KO, selector, sustituto y evento único | Detección, descuento de vida, selector y recuperación al curar: **VALIDADOS FÍSICAMENTE** (alpha.29/30). **ABIERTO:** la baja se registra al terminar el combate, no en el momento del KO; en diagnóstico con `tools_b2w2_battle_faint_capture.py` | Ejecutar la traza de baja en combate |
