...
| PC cambios externos | PC↔PC y Equipo↔PC por identidad | **IMPLEMENTADO · TEST**; validación física pendiente. Hasta alpha.18 el sondeo era inalcanzable: exigía una página `"pc"` a la que la vista unificada no llega | Mover desde el juego con Equipo y PC abierto |
