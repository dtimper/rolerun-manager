...
| Muertes | Baseline, >0→0, varios KO, selector, sustituto y evento único | Detección, descuento de vida, selector y recuperación al curar: **VALIDADOS FÍSICAMENTE** (alpha.29/30). Registro **en el momento del KO** desde alpha.32, con la copia de presentación como autoridad; validación física pendiente | Dejar caer a un miembro y comprobar que la vida baja durante el combate |
