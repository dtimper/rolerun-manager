...
| PC11 · Vacíos/corrupción | Un vacío es la representación cifrada válida de BDSP; jamás ceros por analogía. Writers 3DS y pruebas de empty cifrado. | Vacío PB8 canónico de party/caja alpha.82: **DEMOSTRADO FÍSICAMENTE · IMPLEMENTADO · TEST AUTOMÁTICO** | Existen dos representaciones raw de slot vacío en cajas; el writer usa solo la canónica observada en la transición y rechaza el hueco party no canónico. | Incluida en la prueba PC3/PC4. | PC1, S6–S8. |
