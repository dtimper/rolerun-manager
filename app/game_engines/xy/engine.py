...
class XYEngine(GameEngine):
    """Motor experimental para Pokémon X / Y."""
    ...
    def accepts(self, data: SaveGameData) -> bool:
        ...
        # PKHeX.Core suele identificar X/Y como X/Y y el guardado como SAV6XY.
        # Se admiten variantes textuales para tolerar cambios de representación.
        return (
            game in {"X", "Y", "XY", "POKEMONX", "POKEMONY"}
            or game.endswith("POKEMONX")
            or game.endswith("POKEMONY")
            or "SAV6XY" in save_type
        )
