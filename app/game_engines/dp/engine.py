...
class DPEngine(GameEngine):
    key = "dp"
    display_name = "Pokémon Diamante / Perla"
    ...
    def accepts(self, data: SaveGameData) -> bool:
        ...
        return (
            game in {"DP", "D", "P", "DIAMOND", "PEARL", "DIAMANTE", "PERLA"}
            or "DIAMOND" in game
            or "PEARL" in game
            or "DIAMANTE" in game
            or "PERLA" in game
            or "SAV4DP" in save_type
            or save_type in {"SAV4DIAMOND", "SAV4PEARL"}
        )
