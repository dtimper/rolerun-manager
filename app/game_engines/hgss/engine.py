...
class HGSSEngine(GameEngine):
    key = "hgss"
    display_name = "Pokémon HeartGold / SoulSilver"
    ...
    def accepts(self, data: SaveGameData) -> bool:
        ...
        return (
            game in {"HG", "SS", "HGSS", "HEARTGOLD", "SOULSILVER"}
            or "HEARTGOLD" in game
            or "SOULSILVER" in game
            or "SAV4HGSS" in save_type
        )
