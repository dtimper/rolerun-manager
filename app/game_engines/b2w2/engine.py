...
class B2W2Engine(GameEngine):
    key = "b2w2"
    display_name = "Pokémon Blanco 2 / Negro 2"
    ...
    def accepts(self, data: SaveGameData) -> bool:
        ...
        return (
            game in {"B2", "W2", "B2W2", "BLACK2", "WHITE2", "NEGRO2", "BLANCO2"}
            or "BLACK2" in game or "WHITE2" in game
            or "SAV5B2W2" in save_type
        )
