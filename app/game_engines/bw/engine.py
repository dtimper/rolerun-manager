...
class BWEngine(GameEngine):
    key = "bw"
    display_name = "Pokémon Blanco / Negro"
    ...
    def accepts(self, data: SaveGameData) -> bool:
        ...
        return (
            game in {"B", "W", "BW", "BLACK", "WHITE", "NEGRO", "BLANCO"}
            or game.endswith("BLACK") or game.endswith("WHITE")
            or "SAV5BW" in save_type
        )
