RoleRun Manager 1.13.0-alpha.3
================================

FEEDBACK EN BARRA FLOTANTE
--------------------------
Al pulsar F5 mientras se usa la barra flotante, RoleRun muestra durante un
instante un aviso verde dentro de ella al sincronizar correctamente. Si Azahar
no responde o la lectura no es válida, se muestra un aviso rojo con el motivo.
Este feedback no reabre la ventana principal, no roba el foco al emulador y no
modifica datos del juego.
